...
from sklearn.ensemble import (HistGradientBoostingClassifier, BaggingClassifier, AdaBoostClassifier, RandomForestClassifier, ExtraTreesClassifier, GradientBoostingClassifier)
...
# -----------------------------
# Configurações SMOTETomek/PCA/UMAP
# -----------------------------
configs = [
    (False, False, False),
    (False, False, True),
...
# Cria um dicionário com todas as variáveis importantes
all_vars = {
    "df": df,
    "X_asv": X_asv,
    "y": y,
...
# Nome do arquivo que você acabou de subir
